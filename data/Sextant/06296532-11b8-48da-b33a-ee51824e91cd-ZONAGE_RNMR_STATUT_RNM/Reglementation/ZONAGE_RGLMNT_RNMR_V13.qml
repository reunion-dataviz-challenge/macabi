...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="1" simplifyDrawingTol="1" version="3.4.8-Madeira" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyMaxScale="1" minScale="1e+08" simplifyAlgorithm="0" labelsEnabled="0" readOnly="0">
  ...
  <renderer-v2 enableorderby="0" type="categorizedSymbol" forceraster="0" attr="Statut_RNM" symbollevels="0">
    <categories>
      <category value="1" symbol="0" label="1" render="true"/>
      <category value="2A" symbol="1" label="2A" render="true"/>
      <category value="2B" symbol="2" label="2B" render="true"/>
      <category value="3" symbol="3" label="3" render="true"/>
      <category value="HR" symbol="4" label="HR" render="true"/>
    </categories>
    <symbols>
      <symbol force_rhr="0" type="fill" clip_to_extent="1" name="0" alpha="1">
        <layer locked="0" class="SimpleFill" pass="0" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="71,194,255,255" k="color"/>
        ...
        <layer locked="0" class="LinePatternFill" pass="0" enabled="1">
          ...
          <symbol force_rhr="0" type="line" clip_to_extent="1" name="@1@0" alpha="1">
            <layer locked="0" class="SimpleLine" pass="0" enabled="1">
              ...
              <prop v="bevel" k="joinstyle"/>
              <prop v="71,194,255,255" k="line_color"/>
            ...
            <layer locked="0" class="SimpleLine" pass="0" enabled="1">
              ...
              <prop v="0" k="draw_inside_polygon"/>
              <prop v="bevel" k="joinstyle"/>
              <prop v="69,69,251,255" k="line_color"/>
              <prop v="solid" k="line_style"/>
              <prop v="1.1" k="line_width"/>
              <prop v="MM" k="line_width_unit"/>
              <prop v="1.1" k="offset"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;Alti_GE&quot;">
    <columns>
